...
CREATE TABLE contexts_new (
  ...
  adress varchar(100) COMMENT 'Teksta vienības cilvēklasāmā adrese, P un GNP gadījumā var sakrist vairākām rindām',
  ...
  data_plain text NOT NULL COMMENT 'Tīrs teksta vienības saturs bez HTML',
