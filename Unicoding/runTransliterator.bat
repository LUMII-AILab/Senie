...
perl -e "use LvSenie::Translit::Transliterator qw(transformFile); transformFile(@ARGV)" data Br1520_PN
perl -e "use LvSenie::Translit::Transliterator qw(transformFile); transformFile(@ARGV)" data Manc1638_Run
