	...
	<body background="./images/bg.jpg" onLoad="focusIn();">
		...
		<tr height="30px">
			<td colspan="2" bgcolor="#669933">
				...
				<tr>
					<td><p class="title">Konkordance</p></td>
					<td><p class="navig">
		...
		<tr>
			...
			<td bgcolor="#CCFF99">
				<center><br>
				<form name="search_form" method="GET" action="./kwic.jsp">
					...
					<tr height="122px">
						<td valign="top" style="border-top: 1px #669933 solid; border-right: 1px #669933 solid;">
							...
							<tr>
								<td><p class="hint">Apkaimes garums:&nbsp;</p></td>
								<td>
									<input type="text" name="context" value="50" maxlength="2" class="field" style="width: 50px;">
									<p class="seperator">&nbsp;</p>
								</td>
							</tr>
